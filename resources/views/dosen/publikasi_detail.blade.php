...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Penilaian Publikasi & Diseminasi</h2>
                <p class="text-sm text-gray-500 font-medium">Review dan berikan nilai publikasi mahasiswa</p>
            </div>
        </div>
    </div>
                ...
                <form action="{{ route('dosen.publikasi.nilai', $mahasiswa->nim) }}" method="POST">
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-2 gap-2">
                            @php
                                $kriteria_pub = [
                                    ['key' => 'nilai_ketercapaian', 'label' => 'Substansi'],
                                    ['key' => 'nilai_sistematika', 'label' => 'Sistematika'],
                                    ['key' => 'nilai_kelayakan', 'label' => 'Kelayakan'],
                                    ['key' => 'nilai_presentasi', 'label' => 'Presentasi'],
                                    ['key' => 'nilai_mempertahankan', 'label' => 'Respon'],
                                ];
                            @endphp
