...
<div class="container mx-auto px-4 py-8 max-w-2xl">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-white mb-2">Buat Program Kerja Kelompok</h1>
        <p class="text-gray-300">Tambahkan program kerja kelompok untuk kegiatan {{ ucfirst($mahasiswa->kegiatan) }}</p>
    </div>

    <div class="bg-white rounded-lg shadow p-8">
        <form action="{{ route('program-kerja.store-kelompok') }}" method="POST">
            @csrf

            <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <p class="text-blue-800 text-sm"><strong>Catatan:</strong> Anggota kelompok akan otomatis diisi berdasarkan mahasiswa yang ditempatkan di lokasi yang sama.</p>
            </div>
