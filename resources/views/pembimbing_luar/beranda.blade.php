...
@section('title', 'Beranda Pembimbing Luar')
                ...
                <div class="px-8 pb-8 text-center relative">
                    ...
                    <div class="bg-gray-50 rounded-2xl p-6 text-left space-y-4 border border-gray-100">
                        <div class="flex items-center space-x-4">
                            <div class="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-emerald-600 shadow-sm border border-gray-100">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-bold text-gray-700">{{ $pembimbing->email }}</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex items-center space-x-4">
                    <div class="w-14 h-14 bg-emerald-50 rounded-2xl flex items-center justify-center text-emerald-600 flex-shrink-0">
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
                ...
                <div class="mt-4">
                    <div class="flex justify-between text-xs font-bold text-gray-400 mb-2">
                        <span>Progress</span>
                        <span>{{ round(($sudahDinilai / $totalBimbingan) * 100) }}%</span>
                    </div>
                    <div class="w-full bg-gray-100 rounded-full h-3">
                        <div class="bg-gradient-to-r from-emerald-600 to-emerald-600 h-3 rounded-full transition-all" style="width: {{ round(($sudahDinilai / $totalBimbingan) * 100) }}%"></div>
                    </div>
                </div>
                @endif
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-1 gap-8">
        <a href="{{ route('pembimbing_luar.bimbingan') }}" class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 hover:border-emerald-200 hover:shadow-md transition-all group">
            <div class="flex items-center space-x-6">
                ...
                <div>
                    <h4 class="text-lg font-bold text-gray-800 group-hover:text-emerald-600 transition-colors">Mahasiswa Bimbingan</h4>
                    <p class="text-sm text-gray-500">Lihat daftar, filter, dan kelola nilai mahasiswa bimbingan Anda.</p>
                </div>
                <i class="fas fa-arrow-right text-gray-300 group-hover:text-emerald-600 group-hover:translate-x-1 transition-all ml-auto"></i>
            </div>
        </a>
    </div>
</div>
