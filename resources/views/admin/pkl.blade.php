...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
        ...
        <div class="flex space-x-2">
            <a href="{{ route('admin.mahasiswa.create', ['kegiatan' => 'PKL']) }}" class="inline-flex items-center justify-center px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white font-bold rounded-xl transition-all duration-300 shadow-md shadow-amber-100">
                <i class="fas fa-plus mr-2"></i>
                Tambah Peserta
            </a>
            <a href="{{ route('admin.export.pkl', ['ta' => request('ta')]) }}" class="inline-flex items-center justify-center px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold rounded-xl transition-all duration-300">
                    ...
                    <tr class="hover:bg-blue-50/30 transition-colors group">
                        ...
                        <td class="px-6 py-5">
                            <div class="flex items-center space-x-3">
                                <div class="w-10 h-10 rounded-xl bg-amber-100 text-amber-600 flex items-center justify-center font-bold text-xs border border-amber-200 group-hover:scale-110 transition-transform">
                        ...
                        <td class="px-6 py-5">
                            @php $instansi = $mahasiswa->penempatanpkl?->lokasipkl?->nama_instansi; @endphp
                            @if($instansi)
