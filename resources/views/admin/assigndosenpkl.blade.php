...
@section('title', 'Plotting Dosen Pembimbing PKL')
...
<div class="space-y-8">
    ...
    <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-8 border-b border-gray-50 bg-slate-50/50">
            <h2 class="text-xl font-black text-gray-800 tracking-tight">Plotting Dosen PKL</h2>
            <p class="text-sm text-gray-500 font-medium">Tentukan dosen pendamping untuk mahasiswa PKL di instansi/perusahaan.</p>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div class="lg:col-span-5 space-y-6">
                    <div class="space-y-4">
                        ...
                        <div class="relative">
                            <select name="nidn" required class="w-full pl-5 pr-10 py-4 bg-slate-50 border border-gray-100 rounded-2xl text-gray-700 font-bold focus:outline-none focus:ring-4 focus:ring-amber-500/10 focus:border-amber-500 appearance-none transition-all">
                    ...
                    <div class="pt-4">
                        <button type="submit" class="w-full py-5 bg-amber-500 hover:bg-amber-600 text-white font-black rounded-2xl shadow-xl shadow-amber-100 transition-all flex items-center justify-center space-x-3 group">
                            ...
                            <span class="uppercase tracking-widest text-xs">Simpan Plotting PKL</span>
                        </button>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-8 flex items-center justify-between border-b border-gray-50">
            <h3 class="text-lg font-black text-gray-800 tracking-tight uppercase tracking-widest text-xs">Data Bimbingan PKL</h3>
        </div>
