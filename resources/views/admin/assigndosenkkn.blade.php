...
@section('content')
<div class="container">
    <h2>Assign Dosen Pembimbing KKN</h2>
                    ...
                    @foreach($mahasiswas as $mahasiswa)
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="mahasiswa{{ $mahasiswa->nim }}">
                                {{ $mahasiswa->nama }} ({{ $mahasiswa->nim }}) ({{ $mahasiswa->penempatankkn?->lokasikkn?->desa ?? 'Belum Ditentukan' }})
                            </label>
                        </div>
                    @endforeach
                </div>
    ...
    <table class="table table-bordered mt-2" id="kknTable">
        <thead>
            <tr>
                <th>Mahasiswa</th>
                <th>Dosen</th>
