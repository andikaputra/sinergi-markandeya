...
@section('title', 'Plotting Dosen Pembimbing KKN')
...
<div class="space-y-8">
    ...
    <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-8 flex items-center justify-between border-b border-gray-50">
            <h3 class="text-lg font-black text-gray-800 tracking-tight uppercase tracking-widest text-xs">Data Bimbingan KKN</h3>
        </div>
