...
@section('title', 'Monitoring Program Kerja')
...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-bold text-gray-400 uppercase tracking-widest">Mahasiswa Dengan Program</p>
                    <p class="text-4xl font-black text-gray-900 mt-2">{{ $mahasiswaDenganProgram }}</p>
                    <p class="text-xs text-gray-400 mt-2">dari {{ $totalMahasiswa }}</p>
                </div>
    ...
    <!-- Status Distribution -->
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
        <h3 class="text-xl font-bold text-gray-900 mb-6">Status Distribusi Program Kerja</h3>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                <p class="text-sm font-bold text-gray-600 uppercase">Tunda</p>
                <p class="text-3xl font-black text-gray-900 mt-2">{{ $statistikStatus['tunda'] }}</p>
            </div>
        </div>
    </div>
    ...
    <!-- Quick Actions -->
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <a href="{{ route('admin.program-kerja.mahasiswa-tanpa-program') }}" class="bg-gradient-to-br from-orange-500 to-orange-600 hover:shadow-lg transition-all duration-200 rounded-3xl shadow-lg text-white p-8 flex flex-col justify-between min-h-40">
            <div>
                <i class="fas fa-user-slash text-3xl mb-4 opacity-80"></i>
                <h4 class="font-bold text-lg">Mahasiswa Tanpa Program</h4>
            </div>
            <p class="text-sm opacity-90">{{ $mahasiswaTanpaProgram }} mahasiswa</p>
        </a>

        <a href="{{ route('admin.program-kerja.semua-program') }}" class="bg-gradient-to-br from-blue-500 to-blue-600 hover:shadow-lg transition-all duration-200 rounded-3xl shadow-lg text-white p-8 flex flex-col justify-between min-h-40">
            <div>
                <i class="fas fa-list-check text-3xl mb-4 opacity-80"></i>
                <h4 class="font-bold text-lg">Semua Program Kerja</h4>
            </div>
            <p class="text-sm opacity-90">{{ $totalProgram }} program</p>
        </a>

        <a href="{{ route('admin.program-kerja.semua-luaran') }}" class="bg-gradient-to-br from-purple-500 to-purple-600 hover:shadow-lg transition-all duration-200 rounded-3xl shadow-lg text-white p-8 flex flex-col justify-between min-h-40">
            <div>
                <i class="fas fa-package text-3xl mb-4 opacity-80"></i>
                <h4 class="font-bold text-lg">Semua Luaran</h4>
            </div>
            <p class="text-sm opacity-90">Deliverables</p>
        </a>

        <a href="{{ route('admindashboard') }}" class="bg-gradient-to-br from-gray-500 to-gray-600 hover:shadow-lg transition-all duration-200 rounded-3xl shadow-lg text-white p-8 flex flex-col justify-between min-h-40">
            <div>
                <i class="fas fa-arrow-left text-3xl mb-4 opacity-80"></i>
                <h4 class="font-bold text-lg">Kembali ke Dashboard</h4>
            </div>
    ...
    <!-- Recent Programs -->
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
        <h3 class="text-xl font-bold text-gray-900 mb-6">Program Kerja Terbaru</h3>
