...
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
        <div class="flex-1">
            <h2 class="text-2xl font-bold text-gray-800">Daftar Peserta PPL</h2>
        ...
        <div class="flex space-x-2">
            ...
            <a href="{{ route('admin.print.ppl', ['ta' => request('ta')]) }}" target="_blank" class="inline-flex items-center justify-center px-4 py-2 bg-red-50 text-red-600 hover:bg-red-600 hover:text-white font-bold rounded-xl transition-all duration-300">
                    ...
                    <tr class="hover:bg-blue-50/30 transition-colors group">
                        ...
                        <td class="px-6 py-5 text-center">
                            @if($mahasiswa->publikasis->isNotEmpty())
                                <a href="{{ $mahasiswa->publikasis->first()->link }}" target="_blank" class="text-emerald-600 hover:text-emerald-800 text-xs font-bold">
