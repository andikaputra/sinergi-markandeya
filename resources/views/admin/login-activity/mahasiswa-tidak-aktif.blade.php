    ...
    <div style="max-width: 1200px; margin: 0 auto;">
        ...
        <div style="background: white; padding: 30px; border-radius: 12px; margin-bottom: 40px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
                <h1 style="margin: 0; color: #1a5d4d; font-size: 1.8rem; font-weight: 700;">⏰ Mahasiswa Tidak Login 30 Hari Terakhir</h1>
            ...
            <div style="text-align: center; padding: 60px 20px;">
                ...
                <p style="color: #666; font-size: 1.1rem; font-weight: 600;">Semua mahasiswa aktif login dalam 30 hari terakhir!</p>
            </div>
            @endif
        </div>
    </div>
