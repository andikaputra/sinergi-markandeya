...
@section('title', 'Penempatan Mahasiswa PPL')
...
<div class="space-y-8">
    ...
    <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden">
        ...
        <form action="{{ route('assign.lokasippl.store') }}" method="POST" class="p-8">
            @csrf
                                ...
                                <label class="flex items-center p-4 bg-white border border-gray-100 rounded-2xl cursor-pointer hover:border-emerald-300 hover:bg-emerald-50 transition-all group">
                                    ...
                                    <div class="ml-4 flex-1">
                                        ...
                                        <div class="flex items-center space-x-2 mt-0.5">
                                            ...
                                            <span class="text-[10px] font-bold text-emerald-500 uppercase tracking-tighter">{{ $mahasiswa->prodi }}</span>
                                        </div>
                                    </div>
                                </label>
                            @endforeach
