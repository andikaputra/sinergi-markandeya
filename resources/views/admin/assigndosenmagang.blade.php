...
<div class="space-y-8">
    ...
    <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-8 border-b border-gray-50 bg-slate-50/50">
            <h2 class="text-xl font-black text-gray-800 tracking-tight">Plotting Dosen Magang</h2>
            <p class="text-sm text-gray-500 font-medium">Tentukan dosen pendamping untuk mahasiswa program Magang.</p>
        </div>
