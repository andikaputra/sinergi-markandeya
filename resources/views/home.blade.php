        ...
        <section id="pendaftaran" class="py-20 bg-white border-t border-gray-50">
            <div class="max-w-7xl mx-auto px-6">
                <div class="text-center max-w-2xl mx-auto mb-12 space-y-3">
                    ...
                    <p class="text-gray-400 font-medium">Login terlebih dahulu untuk mendaftar kegiatan pilihan Anda.</p>
                </div>
                    ...
                    <div class="bg-white rounded-[2rem] border {{ $isOpen ? 'border-gold-100 shadow-lg shadow-gold-50' : 'border-gray-100' }} p-8 hover:shadow-xl transition-all">
                        ...
                        <div class="space-y-2 mb-6">
                            ...
                            <div class="flex items-center text-sm text-gray-500">
                                ...
                                <span class="font-medium">Tutup: <strong class="text-gray-700">{{ $ta->tanggal_selesai_daftar->format('d/m/Y') }}</strong></span>
                            </div>
                        </div>
                        ...
                        @else
                        <div class="w-full py-3 bg-gray-50 text-gray-400 font-bold rounded-2xl text-center text-sm border border-gray-100">
